...
namespace ReGraphik.ViewModels
{
    ...
    {
        /// <summary>
        /// Serviço de resíduos que é utilizado para obter os dados dos resíduos do banco de dados
        /// </summary>
        ...
        /// <summary>
        /// Propriedade para armazenar a imagem do usuário, que pode ser selecionada na interface da Dashboard e exibida em um card ou seção de perfil.
        /// </summary>
        private ImageSource _imgFoto;
        public ImageSource ImgFoto
        {
            get => _imgFoto;
        ...
        public DashboardViewModel(string nomeUsuario)
        {
            ...
            /// Inicializa a propriedade do nome do usuário e a imagem do usuário com os valores fornecidos no construtor
            NomeUsuario = nomeUsuario;

            /// Atribui a imagem do usuário usando o serviço de foto, garantindo que a imagem seja carregada corretamente na interface da Dashboard
            ImgFoto = FotoUserService.Foto;

            FotoUserService.FotoMudou += (s, e) => {
                ImgFoto = FotoUserService.Foto;
            };
