...
```mermaid
%%{init: {'theme':'base', 'themeVariables': {'primaryColor':'#E6F1FB','primaryTextColor':'#000000','primaryBorderColor':'#185FA5','lineColor':'#FFFFFF','textColor':'#000000','classText':'#000000','fontSize':'22px'}}}%%
classDiagram
  class Empresa {
    <<Aggregate Root>>
    +string Id
